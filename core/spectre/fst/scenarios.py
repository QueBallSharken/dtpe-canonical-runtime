...
_THIRD_CATEGORY_SCENARIO_ID_002 = "fst_third_category_scenario_002"
_THIRD_CATEGORY_SCENARIO_ID_003 = "fst_third_category_scenario_003"
_THIRD_CATEGORY_SCENARIO_ID_004 = "fst_third_category_scenario_004"
...
_FIFTH_CATEGORY_STRESS_CATEGORY = "path_continuity_stress"

_SIXTH_CATEGORY_SCENARIO_ID = "fst_sixth_category_scenario_001"
_SIXTH_CATEGORY_STRESS_CATEGORY = "transport_continuity_stress"
...
_THIRD_CATEGORY_SCENARIO_002: Dict[str, Any] = {
    "stress_scenario_id": _THIRD_CATEGORY_SCENARIO_ID_002,
    "scenario_name": "Temporal continuity claim with local temporal binding but incomplete end-to-end proof",
    "stress_category": _THIRD_CATEGORY_STRESS_CATEGORY,
    "local_time_window_binding_live": True,
    "end_to_end_temporal_continuity_proven": False,
    "stronger_temporal_claim_asserted": False,
}

_THIRD_CATEGORY_SCENARIO_003: Dict[str, Any] = {
    "stress_scenario_id": _THIRD_CATEGORY_SCENARIO_ID_003,
    "scenario_name": "Temporal continuity claim without live local temporal binding",
    "stress_category": _THIRD_CATEGORY_STRESS_CATEGORY,
    "local_time_window_binding_live": False,
    "end_to_end_temporal_continuity_proven": False,
    "stronger_temporal_claim_asserted": False,
}

_THIRD_CATEGORY_SCENARIO_004: Dict[str, Any] = {
    "stress_scenario_id": _THIRD_CATEGORY_SCENARIO_ID_004,
    "scenario_name": "Temporal continuity claim with end-to-end temporal continuity already proven",
    "stress_category": _THIRD_CATEGORY_STRESS_CATEGORY,
    "local_time_window_binding_live": True,
    "end_to_end_temporal_continuity_proven": True,
    "stronger_temporal_claim_asserted": False,
}
...
_FIFTH_CATEGORY_SCENARIO: Dict[str, Any] = {
    ...
    "stress_category": _FIFTH_CATEGORY_STRESS_CATEGORY,
    "local_path_binding_live": True,
    "end_to_end_path_continuity_proven": False,
    "stronger_path_claim_asserted": True,
}

_SIXTH_CATEGORY_SCENARIO: Dict[str, Any] = {
    "stress_scenario_id": _SIXTH_CATEGORY_SCENARIO_ID,
    "scenario_name": "Transport continuity claim with conflicting stronger delivery-channel assertion",
    "stress_category": _SIXTH_CATEGORY_STRESS_CATEGORY,
    "local_transport_binding_live": True,
    "end_to_end_transport_continuity_proven": False,
    "stronger_transport_claim_asserted": True,
}
...
_SCENARIO_REGISTRY: Dict[Tuple[str, str], Dict[str, Any]] = {
    ...
    (_THIRD_CATEGORY_SCENARIO_ID_002, _THIRD_CATEGORY_STRESS_CATEGORY): _THIRD_CATEGORY_SCENARIO_002,
...
_THIRD_CATEGORY_SCENARIO_IDS = [
    ...
    _THIRD_CATEGORY_SCENARIO_ID_002,
    _THIRD_CATEGORY_SCENARIO_ID_003,
    _THIRD_CATEGORY_SCENARIO_ID_004,
]
...
_FIFTH_CATEGORY_SCENARIO_IDS = [
    _FIFTH_CATEGORY_SCENARIO_ID,
]

_SIXTH_CATEGORY_SCENARIO_IDS = [
    _SIXTH_CATEGORY_SCENARIO_ID,
]
...
_ALL_SUPPORTED_STRESS_CATEGORIES = [
    ...
    _FIFTH_CATEGORY_STRESS_CATEGORY,
    _SIXTH_CATEGORY_STRESS_CATEGORY,
]
...
def get_fifth_category_stress_category() -> str:
    return _FIFTH_CATEGORY_STRESS_CATEGORY


def get_fifth_category_scenario_id() -> str:
    return _FIFTH_CATEGORY_SCENARIO_ID


def get_fifth_category_scenario_ids() -> List[str]:
    return list(_FIFTH_CATEGORY_SCENARIO_IDS)


def get_sixth_category_stress_category() -> str:
    return _SIXTH_CATEGORY_STRESS_CATEGORY


def get_sixth_category_scenario_id() -> str:
    return _SIXTH_CATEGORY_SCENARIO_ID


def get_sixth_category_scenario_ids() -> List[str]:
    return list(_SIXTH_CATEGORY_SCENARIO_IDS)
